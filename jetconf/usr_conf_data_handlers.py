...
# Zone data handler
# class KnotZoneDataListener(ConfDataListHandler):
#     def create_item(self, ii: InstanceRoute, ch: "DataChange"):
#         debug_confh(self.__class__.__name__ + "create_item triggered")
#
...
#         KNOT.zone_remove(domain_name, purge_data=True)
#
...
#         KNOT.zone_add_record(domain_name, soarr)
#
...
#                     KNOT.zone_add_record(domain_name, new_rr)
#
#
...
#         KNOT.zone_del_record(domain_name, rr_owner, rr_type)
#
...
#         debug_confh("KnotApi: deleting {} RR from zone \"{}\"".format(rr_type, domain_name))
#         KNOT.zone_del_record(domain_name, rr_owner, rr_type, selector=rr_sel.rrdata_format())
#
